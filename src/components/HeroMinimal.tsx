...
export default function HeroMinimal({ profile, ctaButtons }: HeroMinimalProps) {
  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-20 md:py-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative w-72 h-[580px] md:w-80 md:h-[650px]">
              {/* Background circle */}
              <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl transform -rotate-6"></div>
